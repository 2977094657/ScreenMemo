...
class IntentAnalysisService {
  ...
  String _buildSystemPrompt(DateTime now, String tzName, String tzReadable) {
    ...
    return [
      ...
      'Return a FIXED schema with explicit local datetimes, do NOT fallback.',
      ...
      'If the time period is ambiguous or missing, DO NOT default to today. Instead, set an error object and leave start_local/end_local empty.',
  ...
  String _buildUserPrompt(
    ...
    lines.addAll(<String>[
      ...
      '  "start_local": "YYYY-MM-DDTHH:mm:ss±HH:MM（本地时间，带偏移，例如 2025-10-10T00:00:00+08:00）",',
      '  "end_local":   "YYYY-MM-DDTHH:mm:ss±HH:MM（本地时间，带偏移）",',
      ...
      '}',
      'Rules:',
      '- 必须返回 start_local 与 end_local（ISO-8601，含偏移）；禁止默认到“今天”。',
      '- 若用户未给出可解析的日期/时间或存在歧义，请仅返回 error，并保持 start_local/end_local 为空。',
