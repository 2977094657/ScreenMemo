...
class FlutterLogger {
  ...
  static Future<void> setEnabled(bool value, {bool persist = true}) async {
    ...
    // 立刻同步原生落盘与级别
    try {
      await _channel.invokeMethod('setFileLoggingEnabled', {'enabled': value});
      await _channel.invokeMethod('setNativeLogLevel', {
  ...
  static Future<void> nativeDebug(String tag, String message) =>
      native('debug', tag, message);
  static Future<void> nativeInfo(String tag, String message) =>
      native('info', tag, message);
  static Future<void> nativeWarn(String tag, String message) =>
      native('warn', tag, message);
  static Future<void> nativeError(String tag, String message) =>
      native('error', tag, message);
  ...
  static Future<void> umengBreadcrumb(
    String message, {
    String tag = 'Flutter',
  }) async {
    // no-op: Umeng SDK 已移除
  ...
  static Future<void> umengReportError(
    Object error, [
