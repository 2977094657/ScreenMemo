...
import 'package:screen_memo/services/ui_thinking_json_patcher.dart';

void main() {
  test('patchUiThinkingJsonWithToolUiEvent creates v2 base and upserts tool chips', () {
    ...
    final Map<String, dynamic> decoded = jsonDecode(out!) as Map<String, dynamic>;
    expect(decoded['v'], 2);
  ...
  test('patchUiThinkingJsonWithToolUiEvent marks tool_call_end inactive and stores summary', () {
  ...
  test('patchUiThinkingJsonWithToolUiEvent returns original on invalid json', () {
    final String raw = '{not json';
    expect(
      patchUiThinkingJsonWithToolUiEvent(
        raw,
        <String, dynamic>{'type': 'tool_call_end', 'call_id': 'c1', 'tool_name': 't'},
